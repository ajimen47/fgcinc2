...
class DatabaseHelper {
  ...
  late String noteTable = 'note_table';
  late String colId = 'id';
  late String colTitle = 'title';
  late String colDescription = 'description';
  late String colPriority = 'priority';
  late String colColor = 'color';
  late String colDate = 'date';

  DatabaseHelper._createInstance(); // Named constructor to create instance of DatabaseHelper

  late factory DatabaseHelper() {
